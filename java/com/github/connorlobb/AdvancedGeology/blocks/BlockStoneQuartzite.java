...
public class BlockStoneQuartzite extends Block {
	public BlockStoneQuartzite() {
		super(Material.rock);
		setBlockName("stoneQuartzite");
	...
	public Item getItemDropped(int metadata, Random random, int fortune) {
		return Item.getItemFromBlock(ModBlocks.cobblestoneQuartzite);
	}
}
