...
public class BlockStoneDolomite extends Block {
	public BlockStoneDolomite() {
		super(Material.rock);
		setBlockName("stoneDolomite");
	...
	public Item getItemDropped(int metadata, Random random, int fortune) {
		return Item.getItemFromBlock(ModBlocks.cobblestoneDolomite);
	}
}
