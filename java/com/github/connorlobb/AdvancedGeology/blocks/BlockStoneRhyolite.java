...
public class BlockStoneRhyolite extends Block {
	public BlockStoneRhyolite() {
		super(Material.rock);
		setBlockName("stoneRhyolite");
	...
	public Item getItemDropped(int metadata, Random random, int fortune) {
		return Item.getItemFromBlock(ModBlocks.cobblestoneRhyolite);
	}
}
