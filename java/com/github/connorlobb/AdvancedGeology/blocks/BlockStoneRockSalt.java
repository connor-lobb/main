...
public class BlockStoneRockSalt extends Block {
	public BlockStoneRockSalt() {
		super(Material.rock);
		setBlockName("stoneRockSalt");
	...
	public Item getItemDropped(int metadata, Random random, int fortune) {
		return Item.getItemFromBlock(ModBlocks.cobblestoneRockSalt);
	}
}
