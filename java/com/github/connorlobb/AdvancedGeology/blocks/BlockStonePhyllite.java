...
public class BlockStonePhyllite extends Block {
	public BlockStonePhyllite() {
		super(Material.rock);
		setBlockName("stonePhyllite");
	...
	public Item getItemDropped(int metadata, Random random, int fortune) {
		return Item.getItemFromBlock(ModBlocks.cobblestonePhyllite);
	}
}
