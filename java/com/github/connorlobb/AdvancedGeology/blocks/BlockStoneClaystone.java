...
public class BlockStoneClaystone extends Block {
	public BlockStoneClaystone() {
		super(Material.rock);
		setBlockName("stoneClaystone");
	...
	public Item getItemDropped(int metadata, Random random, int fortune) {
		return Item.getItemFromBlock(ModBlocks.cobblestoneClaystone);
	}
}
