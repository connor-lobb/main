...
public class BlockStoneConglomerate extends Block {
	public BlockStoneConglomerate() {
		super(Material.rock);
		setBlockName("stoneConglomerate");
	...
	public Item getItemDropped(int metadata, Random random, int fortune) {
		return Item.getItemFromBlock(ModBlocks.cobblestoneConglomerate);
	}
}
