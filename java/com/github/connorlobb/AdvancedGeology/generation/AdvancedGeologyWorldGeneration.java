...
public class AdvancedGeologyWorldGeneration implements IWorldGenerator {
	...
	private void generateSurface(World world, Random random, int x, int z) {
		...
		addOreSpawn(ModBlocks.stoneShale, world, random, x, z, 16, 16, 40 + random.nextInt(20), 10, 60, 128);
		//Metamorphic
		...
		addOreSpawn(ModBlocks.stoneSchist, world, random, x, z, 16, 16, 40 + random.nextInt(20), 15, 30, 128);
		addOreSpawn(ModBlocks.stoneSlate, world, random, x, z, 16, 16, 40 + random.nextInt(20), 15, 30, 128);
		//Igneous
